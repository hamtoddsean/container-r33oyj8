...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r33oyj8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r33oyj8.containers.anotherwebservice.com/
...
```
git clone git@github.com:hamtoddsean/container-r33oyj8.git
cd container-r33oyj8
```
...
```
docker attach container-r33oyj8
```
